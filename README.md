...
In this assignment, you'll create one computer games: Word Guess. These apps will run in the browser, and feature dynamically updated HTML and CSS powered by your JavaScript code.
...
:pushpin::pushpin:**Word Guess Game Bonuses** :pushpin::pushpin:  
